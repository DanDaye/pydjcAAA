...
//                         ca.append("<cite>"+item2.name+"</cite>");
             ...
             // var a = $("<a href='/pages/pred/featureAnalysis.html' ></a >");
             // var css = "";
             // if(css!=null && css!=""){
             //     a.append("<i style='color:white' aria-hidden='true' class='fa " + css +"'></i>&nbsp;");
             // }
             // a.append("<span style='color:white'>" + "电力负荷预测" + "</span>");
             // a.append("<span class='layui-nav-more'/>");
             // a.attr("lay-id", "电力负荷预测");
			 //
             // var href = "/pages/pred/featureAnalysis.html";
             // if(href != null && href != ""){
             //     a.attr("data-url", href);
             // }
             // var li = $("<li class='layui-nav-item'></li>");
             ...
             //         name: "特征分析",
             //         css: "",
             //         href: "/pages/pred/featureAnalysis.html",
             //         child: [ ]
             //     },
             //     {
             //         id: 'moxing2',
